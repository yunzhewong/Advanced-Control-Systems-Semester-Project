...
A_aa_disc = disc_a(1:2, 1:2);
A_ab_disc = disc_a(1:2, 3:4);
A_ba_disc = disc_a(3:4, 1:2);
A_bb_disc = disc_a(3:4, 3:4);

B_a_disc = disc_b(1:2, :);
B_b_disc = disc_b(3:4, :);

disc_poles = exp([closest_pole, closest_pole+1] * min_sampling_time);
